...
// This shader is used as an example of how the Input Sockets of a Matchbox node can be coloured.
// The colours are not set in this .glsl file, but in the associated .xml file.
